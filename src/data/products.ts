...
export const products: Product[] = [
...

  {
    ...
    unit: 'box',
    arUnit: 'علبة',
    image: '/images/red-grapes.webp',    inStock: true,
  },
  {
    id: 'curry-leaves',
    name: 'Curry Leaves',
    ...
    unit: '60g',
    arUnit: '٦٠ غرام',
    image: '/images/curry-leaves.webp',    badge: 'Aromatic',
    arBadge: 'عطري',
    badgeColor: 'bg-brand-500',
    inStock: true,
  },
  {
    ...
    unit: 'kg',
    arUnit: 'كجم',
    image: '/images/papaya.webp',    inStock: true,
  },
  {
    id: 'ivy-gourd',
    name: 'Ivy Gourd',
    ...
    unit: 'kg',
    arUnit: 'كجم',
    image: '/images/ivy-gourd.webp',    inStock: true,
  },
  {
    id: 'small-onion',
    name: 'Small Onion',
    ...
    unit: 'kg',
    arUnit: 'كجم',
    image: '/images/small-onion.webp',    inStock: true,
  },
  {
    id: 'raw-banana',
    name: 'Raw Banana',
    ...
    unit: 'kg',
    arUnit: 'كجم',
    image: '/images/raw-banana.webp',    inStock: true,
  },
  {
    id: 'taro-root',
    name: 'Taro Root',
    ...
    unit: 'kg',
    arUnit: 'كجم',
    image: '/images/taro-root.webp',    inStock: true,
  },
  {
    id: 'bitter-gourd',
    name: 'Bitter Gourd',
    ...
    unit: 'kg',
    arUnit: 'كجم',
    image: '/images/bitter-gourd.webp',    inStock: true,
  },
  {
    id: 'yellow-indian-cucumber',
    name: 'Yellow Indian Cucumber',
    arName: 'خيار هندي أصفر',
    category: 'vegetables',
    arCategory: 'خضروات',
    price: 2.5,
    arPrice: '٢٫٥٠',
    unit: 'kg',
    arUnit: 'كجم',
    image: '/images/yellow-indian-cucumber.webp',    badge: 'Fresh Daily',
    arBadge: 'طازج يومياً',
    badgeColor: 'bg-brand-700',
    inStock: true,
  },
  {
    ...
    unit: '2 pieces',
    arUnit: 'قطعتين',
    image: '/images/drumstick.webp',    badge: 'Fresh Daily',
    arBadge: 'طازج يومياً',
    badgeColor: 'bg-brand-700',
    inStock: true,
  },];
